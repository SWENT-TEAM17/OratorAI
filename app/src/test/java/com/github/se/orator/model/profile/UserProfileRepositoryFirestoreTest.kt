...
class UserProfileRepositoryFirestoreTest {
    ...
    fun getUserProfileCallsDocuments(){
        ...
        repository.getUserProfile(testUserProfile.uid,
            onSuccess = {
            },
    ...
    fun getFriendsProfiles_whenFriendUidsEmpty_shouldReturnEmptyList() {
        ...
        repository.getFriendsProfiles(emptyList(),
            onSuccess = { friends ->
    ...
    fun getFriendsProfiles_whenQuerySuccessful_shouldReturnListOfFriends() {
        ...
        `when`(mockQuerySnapshot.documents).thenReturn(listOf(mockDocumentSnapshot, mockDocumentSnapshot))
        ...
        repository.getFriendsProfiles(friendUids,
            onSuccess = { friends ->
