...
class ViewFriendsScreenTest {
    ...
    private val mockFriendsProfiles = listOf(
        UserProfile("1", "John Doe", 25, "https://someurl.com/johndoe.jpg", statistics = null, friends = listOf(), bio = "Loves coding"),
        UserProfile("2", "Jane Smith", 30, "https://someurl.com/janesmith.jpg", statistics = null, friends = listOf(), bio = "UI/UX Designer")
    )
