...
class EndToEndAppTest {
  ...
  fun testEndToEndNavigationAndUI() {
    ...
    composeTestRule.onNodeWithTag("bio_field").assertTextContains("adding text Test bio")
    ...
    verify(navigationActions).navigateTo(Screen.LEADERBOARD)
    ...
    verify(navigationActions).navigateTo(Screen.ADD_FRIENDS)
