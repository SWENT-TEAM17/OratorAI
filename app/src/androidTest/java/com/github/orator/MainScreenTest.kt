...
class MainScreenTest {
  ...
  fun testWelcomeTextIsDisplayed() {
    ...
    composeTestRule.onNodeWithTag("mainScreenText1").assertExists().assertTextContains("Find your")
  ...
  fun testToolbarIsDisplayedAndClickable() {
    ...
    composeTestRule.onNodeWithTag("toolbar").assertExists().assertIsDisplayed()
  ...
  fun testStackedCardsAreDisplayed() {
    ...
    composeTestRule.onNodeWithTag("animatedCards").assertExists().assertIsDisplayed()
  }
}
