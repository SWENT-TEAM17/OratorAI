package com.github.orator.ui.authentification
...
import com.github.se.orator.MainActivity
...
class LoginTest : TestCase() {
    ...
    fun titleAndButtonAreCorrectlyDisplayed() {
        composeTestRule.onNodeWithTag("mainLoginTitle").assertIsDisplayed()
        composeTestRule.onNodeWithTag("mainLoginTitle").assertTextEquals("OratorAI")
