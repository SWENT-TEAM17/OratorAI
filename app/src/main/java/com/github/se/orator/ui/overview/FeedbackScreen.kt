...
//                    Button(
//                        onClick = {
//                            val practiceContextJson = Uri.encode(Gson().toJson(chatViewModel.practiceContext))
//                            val feedbackType = chatViewModel.feedbackType
//
//                            if (practiceContextJson != null && feedbackType.isNotEmpty()) {
//                                navController.navigate("${Screen.CHAT_SCREEN}/$practiceContextJson/$feedbackType") {
//                                    // Remove the current FeedbackScreen from the back stack
//                                    popUpTo(Screen.CHAT_SCREEN) { inclusive = true }
//                                }
//                            } else {
//                                Log.e("FeedbackScreen", "practiceContext or feedbackType is null")
//                            }
//                        },
