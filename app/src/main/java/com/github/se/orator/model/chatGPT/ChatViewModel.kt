...
class ChatViewModel(
    ...
    suspend fun generateFeedback(): String? {
        try {
            ...
            val outcomeRequest = when (practiceContextAsValue) {
                is InterviewContext -> "Based on my performance, would you recommend hiring me for the position? And say specifically Yes I would hire you or No I would not hire you. Please provide reasons for your decision."
                is PublicSpeakingContext -> "Based on my performance, would I win the competition? And say specifically 'Yes I would win the competition' or 'No I would not win the competition'. Please provide reasons for your decision."
                is SalesPitchContext -> "Based on my performance, did I successfully convince you in the negotiation? And say specifically 'Yes you successfully convinced me' or 'No you did not convince me'. Please provide reasons for your decision."
