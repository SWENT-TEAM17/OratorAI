...
/**
 * ViewModel to manage the state of offline mode and any related logic.
 * It exposes a LiveData to observe the offline state and handles any data
 * or actions needed when the app is offline.
 */
