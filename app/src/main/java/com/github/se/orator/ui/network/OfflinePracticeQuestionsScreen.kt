...
/**
 * Composable function to display a list of predefined questions for offline practice.
 * When the user clicks on a question, they are navigated to a recording screen
 * with the selected question passed as a parameter.
 *
...
fun OfflinePracticeQuestionsScreen(navController: NavController) {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(WindowInsets.systemBars.asPaddingValues()) // Adds padding to adapt to system bars
        ...
        Text(
            text = "Choose a question to practice:",
            fontSize = 20.sp
        )
        ...
        questions.forEach { question ->
            Text(
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        // Here we need to navigate to the recording screen and pass the selected question as a parameter
                        // should we ask for all the parameters ? or hardcode parameters for when we're back online ...
