 ...
 * @param permissionGranted Boolean that tells us whether permission to record a screen has been granted or not
 * */
...
@Composable
fun handleAudioRecording(analysisState: State<SpeakingRepository.AnalysisState>,
                         permissionGranted: MutableState<Boolean>,
